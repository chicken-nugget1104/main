...
public class Tile {
    ...
    public static Tile woodplank = new Tile(5, 4);
    public static Tile bush = new Bush(6);
    public static Tile bedrock = new Tile(7, 17);
    public static Tile glass = new Tile(8, 36).setTransparent(true);
    public static Tile rose = new Rose(9);
    public static Tile brick = new Tile(10, 7);
    public static Tile bookshelf = new Tile(11, 36);
    public static Tile wood = new OakWoodTile(12);
    public static Tile leaf = new Tile(13, 22);
    public static Tile sand = new Sand(14);
     ...
     *
     * @param isTransparent true if the tile is transparent
     * @return the tile itself for chaining
     */
    public Tile setTransparent(boolean isTransparent) {
    ...
    /**
     * Tile get liquid type
     *
     * @return Returns liquid type.
     */
